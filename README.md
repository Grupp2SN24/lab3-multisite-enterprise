...
| PE2 | NAT (Gi0/3 → ISP), OSPF utökat mot CE-DC, default-information originate, default route via DHCP |
| PE-A | OSPF utökat mot CE-A, statisk default route via PE1 |
| PE-B | OSPF utökat mot CE-B, statisk default route via PE2 |
| CE-DC | OSPF tillagt, allowas-in 2 på BGP, network 10.20.2.0/24, utökad VRF-leaking (MGMT↔SERVICES) |
| CE-A | OSPF tillagt, statisk default route via PE-A |
